...
@Composable
fun AiPromptScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text("ex. create a diet meal with chicken, eggs and mushrooms.") },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(140.dp)
            )
